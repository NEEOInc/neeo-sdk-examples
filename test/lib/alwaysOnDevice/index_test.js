...
describe('./lib/alwaysOnDevice/index.js', function() {
  ...
  beforeEach(function() {
    ...
    mockery.registerMock('./MediaPlayerController', controller);
    adapter = requireHelper('lib/alwaysOnDevice');
  });
  ...
  it('should set accessory type', function() {
    ...
    expect(device.deviceCapabilities).to.include('alwaysOn');
  });
});
